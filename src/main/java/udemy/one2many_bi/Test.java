package udemy.one2many_bi;

import org.hibernate.Session;
import org.hibernate.SessionFactory;
import org.hibernate.cfg.Configuration;
import udemy.one2many_bi.entity.Department;
import udemy.one2many_bi.entity.Employee;
...
public class Test {
    ...
    static void insert() {
        ...
        try {
            ...
            */
            ...
            Department #1 {name='IT', maxSalary=100, minSalary=500}
            ...
            [Employee #1 {name='Сергей', surname='Ионов', salary=350, departmentId=1}, Employee #2 {name='Александр', surname='Смирнов', salary=300, departmentId=1}, Employee #3 {name='Марина', surname='Петрова', salary=250, departmentId=1}]
            Hibernate: select department0_.id as id1_0_0_, department0_.max_salary as max_sala2_0_0_, department0_.min_salary as min_sala3_0_0_, department0_.name as name4_0_0_ from departments_o2m department0_ where department0_.id=?
            Department #2 {name='Sale', maxSalary=200, minSalary=400}
            Hibernate: select employees0_.department_id as departme2_1_0_, employees0_.id as id1_1_0_, employees0_.id as id1_1_1_, employees0_.department_id as departme2_1_1_, employees0_.name as name3_1_1_, employees0_.salary as salary4_1_1_, employees0_.surname as surname5_1_1_ from employees_o2m employees0_ where employees0_.department_id=?
            [Employee #4 {name='Юлия', surname='Авакова', salary=280, departmentId=2}, Employee #5 {name='Борис', surname='Леонов', salary=280, departmentId=2}]
            insert check Done!
    ...
    static void update() {
        ...
        try {
            (session = factory.getCurrentSession()).beginTransaction();
            ...
            /*
            Hibernate: select employee0_.id as id1_1_0_, employee0_.department_id as departme2_1_0_, employee0_.name as name3_1_0_, employee0_.salary as salary4_1_0_, employee0_.surname as surname5_1_0_, department1_.id as id1_0_1_, department1_.max_salary as max_sala2_0_1_, department1_.min_salary as min_sala3_0_1_, department1_.name as name4_0_1_ from employees_o2m employee0_ left outer join departments_o2m department1_ on employee0_.department_id=department1_.id where employee0_.id=?
            Employee #3 {name='Марина', surname='Петрова', salary=250, departmentId=1}
            Hibernate: select department0_.id as id1_0_0_, department0_.max_salary as max_sala2_0_0_, department0_.min_salary as min_sala3_0_0_, department0_.name as name4_0_0_ from departments_o2m department0_ where department0_.id=?
            Hibernate: update employees_o2m set department_id=?, name=?, salary=?, surname=? where id=?
            update Done!
            */
            ...
            System.out.println(dep.getEmployees());  // внутри транзакции из-за FetchType.LAZY
            ...
            Department #2 {name='Sale', maxSalary=200, minSalary=400}
            Hibernate: select employees0_.department_id as departme2_1_0_, employees0_.id as id1_1_0_, employees0_.id as id1_1_1_, employees0_.department_id as departme2_1_1_, employees0_.name as name3_1_1_, employees0_.salary as salary4_1_1_, employees0_.surname as surname5_1_1_ from employees_o2m employees0_ where employees0_.department_id=?
            [Employee #3 {name='Марина', surname='Петрова', salary=250, departmentId=2}, Employee #4 {name='Юлия', surname='Авакова', salary=280, departmentId=2}, Employee #5 {name='Борис', surname='Леонов', salary=280, departmentId=2}]
            update check Done!
